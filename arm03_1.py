    ...
    while cap.isOpened():
        ...
        try:
            ...
            shoulder_R = [landmarks[mp_pose.PoseLandmark.RIGHT_SHOULDER.value].x,
                          landmarks[mp_pose.PoseLandmark.RIGHT_SHOULDER.value].y]  # landmarks獲取座標(取左肩X值，取Y值)
            ...
            if angle_R > 170 and angle_L < 10:
                stage = "down"
            if angle_R < 140 and angle_L > 40 and stage == 'down':  # 希望做動作時是由down的狀態往up的狀態，不希望手直接舉高
                stage = "up"
                counter += 1
                print(counter)
                if counter == 10:
